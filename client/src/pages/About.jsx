      ...
      <div className="flex flex-col md:flex-row justify-center items-center w-full max-w-6xl gap-6 md:gap-12">
        ...
        >
          <p className="font-bold text-slate-600">
            ...
            and user-friendly web applications. Skilled in React.js, Next.js,
            Redux Toolkit,and Tailwind CSS, I focus on creating responsive and
            high-performance user interfaces. I thrive in collaborative
            environments and love leveraging modern technologies to deliver
